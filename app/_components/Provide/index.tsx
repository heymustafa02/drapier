...
const Aboutdata: datatype[] = [
    {
        ...
        paragraph: "Organize ideas effortlessly with Drapier.",
    },
    {
        country: "Note Taking",
        paragraph: "Capture key points instantly.",
    },
    {
        country: "Ideation",
        paragraph: "Develop concepts with ease.",
    },
    {
        country: "Sketching",
        paragraph: "Bring ideas to life visually.",
    }
                ...
                <div className='grid grid-cols-1 lg:grid-cols-12 gap-8'>
                    ...
                    <div className='col-span-6 flex justify-center'>
                        <div className="flex flex-col align-middle justify-center p-10">
                            ...
                            <h4 className="text-lg pt-4 font-normal lh-33 text-center lg:text-start text-bluegray">At Drapier, we believe in delivering quality that speaks for itself. Our platform is built to bring your ideas to life with ease, whether you're brainstorming, sketching, or planning.</h4>
