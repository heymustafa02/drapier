        ...
        <div className="grid grid-cols-1 gap-y-10 gap-x-6 lg:grid-cols-2 xl:gap-x-8">
          ...
          <div className="hidden lg:block">
            <div className="float-right pt-20 relative">
              <Image src="/assets/newsletter/bgImage.png" alt="Background" width={588} height={334} />
              <div className="absolute top-10 right-0">
                <Image src="/assets/newsletter/leaf.svg" alt="Leaf" width={81} height={81} />
              </div>
              <div className="absolute bottom-8 left-2">
                <Image src="/assets/newsletter/circle.svg" alt="Circle" width={30} height={30} />
              </div>
            </div>
          </div>
          ...
          <div className="p-10 flex flex-col justify-center">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
              ...
              {/* Submit Button */}
              <button type="submit" className="bg-blue-900 text-white font-medium py-2 px-4 rounded-full">
                <Image src="/assets/newsletter/plane.svg" alt="Send" width={20} height={20} />
              </button>
