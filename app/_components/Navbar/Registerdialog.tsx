        ...
        <>
            <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto  sm:pr-0">
                <div className='hidden lg:block'>
                    <button className="text-blue-500 text-lg font-medium ml-9 py-5 px-16 transition duration-150 ease-in-out leafbutton bg-sky-400 hover:text-white hover:bg-sky-600" onClick={openModal}>
                        Register
                    </button>
                </div>
            </div>
